...
{
    public class SettingsWindowPresenter : SingletonMonoBehaviour<SettingsWindowPresenter>
    {
        [SerializeField]
        ...
        void Awake()
        {
            ...
            Settings.IsOpen.Subscribe(_ =>
            {
                noteEditorObj.SetActive(!Settings.IsOpen.Value);
            });
