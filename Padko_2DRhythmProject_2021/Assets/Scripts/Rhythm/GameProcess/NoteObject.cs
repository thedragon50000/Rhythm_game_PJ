...
namespace Game.Process
{
    ...
    public class NoteObject : MonoBehaviour
    {
        ...
        public void Click()
        {
            ...
            //ParticleEffectsController.Instance.CreateClickEffect(transform.position);//new Vector3(transform.position.x, UISizeController.Instance.CLICK_EFFECT_Y));
            ...
            */
            ...
            if (Type() == 2)
            {
                if (chainedNotes.Count==0 && GetHoldingBar())
                {
                    GetHoldingBar().gameObject.SetActive(false);
                }
            }
