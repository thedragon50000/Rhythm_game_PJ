...
_PlasmaFX_Fade_1("_PlasmaFX_Fade_1", Range(0, 1)) = 0.705
_PlasmaFX_Speed_1("_PlasmaFX_Speed_1", Range(0, 1)) = 0.759
_DisplacementPack_ValueX_1("_DisplacementPack_ValueX_1", Range(-1, 1)) = 0.013
_DisplacementPack_ValueY_1("_DisplacementPack_ValueY_1", Range(-1, 1)) = -0.142
_DisplacementPack_Size_1("_DisplacementPack_Size_1", Range(-3, 3)) = 1
DisplacementPack_1("DisplacementPack_1(RGB)", 2D) = "white" { }
_Simple_Displacement_Rotative_Value_1("_Simple_Displacement_Rotative_Value_1", Range(-0.3, 0.3)) = -0.12
_Simple_Displacement_Rotative_Rotation_1("_Simple_Displacement_Rotative_Rotation_1", Range(-1, 1)) = -0.239
_ShadowLight_Precision_1("_ShadowLight_Precision_1", Range(1, 32)) = 17.196
_ShadowLight_Size_1("_ShadowLight_Size_1", Range(0, 16)) = 2.192
_ShadowLight_Color_1("_ShadowLight_Color_1", COLOR) = (1,0.7728195,0.1764706,1)
_ShadowLight_Intensity_1("_ShadowLight_Intensity_1", Range(0, 4)) = 1.982
_ShadowLight_PosX_1("_ShadowLight_PosX_1", Range(-1, 1)) = 0
_ShadowLight_PosY_1("_ShadowLight_PosY_1", Range(-1, 1)) = -0.059
...
_LerpUV_Fade_1("_LerpUV_Fade_1", Range(0, 1)) = 0
...
float4 OperationBlend_1 = OperationBlend(_PlasmaFX_1, OperationBlend_2, _OperationBlend_Fade_1); 
