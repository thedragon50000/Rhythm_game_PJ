...
_Burn_Value_1("_Burn_Value_1", Range(0, 1)) = 0.454
_Burn_Speed_1("_Burn_Speed_1", Range(-8, 8)) = 1.518
...
float4 _Burn_1 = BurnFX(OperationBlend_2,i.texcoord,_Burn_Value_1,_Burn_Speed_1,0);
float4 OperationBlend_1 = OperationBlend(NewTex_1, _Burn_1, _OperationBlend_Fade_1); 
