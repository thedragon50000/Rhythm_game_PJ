...
AnimatedZoomUV_AnimatedZoomUV_Speed_1("AnimatedZoomUV_AnimatedZoomUV_Speed_1", Range(-10, 10)) = 0
...
{
float4 _Hologram_1 = Hologram(i.texcoord,_MainTex,0,0.75);
...
float4 _Generate_Line_1 = Generate_Lines(AnimatedZoomUV_1.x,146,0);
_Hologram_1 = lerp(_Hologram_1,_Hologram_1 * _Generate_Line_1,0.572);
